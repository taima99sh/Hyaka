//
//  CodeChangePasswordViewController.swift
//  Hyakah
//
...
class CodeChangePasswordViewController: UIViewController {
    ...
    @IBOutlet weak var btnToChangePassword: UIButton!
    ...
    @IBAction func btnToChangePassword(_ sender: Any) {
...
extension CodeChangePasswordViewController {
    func setupView(){
...
extension CodeChangePasswordViewController: UITextFieldDelegate {
